...
if (onnxruntime_USE_CUDA)
  ...
  if(MSVC)
    target_compile_options(onnxruntime_providers_cuda PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:--compiler-options /utf-8>" "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:/utf-8>")
  endif()
  if (UNIX)
...
if (onnxruntime_USE_DNNL)
  ...
  if(MSVC)
    target_compile_options(onnxruntime_providers_dnnl PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:--compiler-options /utf-8>" "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:/utf-8>")
  endif()
...
if (onnxruntime_USE_TENSORRT)
  ...
  if(MSVC)
    target_compile_options(onnxruntime_providers_tensorrt PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:--compiler-options /utf-8>" "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:/utf-8>")
  endif()
...
if (onnxruntime_USE_NGRAPH)
  ...
  if(MSVC)
    target_compile_options(onnxruntime_providers_ngraph PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:--compiler-options /utf-8>" "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:/utf-8>")
  endif()
...
if (onnxruntime_USE_DML)
  ...
  if(MSVC)
    target_compile_options(onnxruntime_providers_dml PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:--compiler-options /utf-8>" "$<$<NOT:$<COMPILE_LANGUAGE:CUDA>>:/utf-8>")
  endif()
